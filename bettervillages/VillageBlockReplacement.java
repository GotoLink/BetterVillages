...
public final class VillageBlockReplacement extends FileParser {
    ...
    private static final Type mapType = new TypeToken<Map<String, BlockReplace>>() {
    }.getType();
     ...
     */
    public BlockAndMeta doReplace(final IBlockState state, final BiomeGenBase biome) {
        final Block block = state.getBlock();
        final int type = block.getMetaFromState(state);
